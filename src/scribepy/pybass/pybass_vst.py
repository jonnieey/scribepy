...
BASS_VST_ChannelFree = func_type(HSTREAM, ctypes.c_ulong)(
    ("BASS_VST_ChannelFree", bass_vst_module)
)

BASS_VST_GetParamCount = func_type(HSTREAM, ctypes.c_ulong)(
    ("BASS_VST_GetParamCount", bass_vst_module)
)

BASS_VST_GetParam = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_int)(
...
BASS_VST_GetProgramCount = func_type(HSTREAM, ctypes.c_ulong)(
    ("BASS_VST_GetProgramCount", bass_vst_module)
)

BASS_VST_GetProgram = func_type(HSTREAM, ctypes.c_ulong)(
    ("BASS_VST_GetProgram", bass_vst_module)
)

BASS_VST_SetProgram = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_int)(
...
BASS_VST_GetProgramName = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_int)(
...
BASS_VST_Resume = func_type(HSTREAM, ctypes.c_ulong)(
    ("BASS_VST_Resume", bass_vst_module)
)

BASS_VST_SetBypass = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_bool)(
    ("BASS_VST_SetBypass", bass_vst_module)
)

BASS_VST_GetBypass = func_type(HSTREAM, ctypes.c_ulong)(
...
BASS_VST_EmbedEditor = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_void_p)(
    ("BASS_VST_EmbedEditor", bass_vst_module)
)

BASS_VST_SetScope = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_VST_SetLanguage = func_type(HSTREAM, ctypes.c_char_p)(
