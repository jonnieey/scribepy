...
BASS_SFX_PluginModuleGetActive = func_type(HSTREAM, HSFX)(
...
BASS_SFX_PluginRender = func_type(HSTREAM, HSFX, HSTREAM, ctypes.c_void_p)(
...
BASS_SFX_PluginResize = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int)(
...
BASS_SFX_PluginFree = func_type(HSTREAM, HSFX)(
