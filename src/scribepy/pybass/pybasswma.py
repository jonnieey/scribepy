...
BASS_WMA_ENCODE_SCRIPT = (
    0x20000  # set script (mid-stream tags) in the WMA encoding
)
...
BASS_WMA_GetTags = func_type(ctypes.c_char_p, ctypes.c_void_p, ctypes.c_ulong)(
...
BASS_WMA_EncodeGetPort = func_type(ctypes.c_ulong, HWMENCODE)(
...
BASS_WMA_EncodeGetClients = func_type(ctypes.c_ulong, HWMENCODE)(
...
BASS_WMA_EncodeClose = func_type(ctypes.c_byte, HWMENCODE)(
    ("BASS_WMA_EncodeClose", basswma_module)
)

# void *BASSWMADEF(BASS_WMA_GetWMObject)(DWORD handle);
BASS_WMA_GetWMObject = func_type(ctypes.c_void_p, ctypes.c_ulong)(
