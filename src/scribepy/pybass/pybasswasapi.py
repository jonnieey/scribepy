...
BASS_WASAPI_SetDevice = func_type(HSTREAM, ctypes.c_ulong)(
...
BASS_WASAPI_GetInfo = func_type(HSTREAM, ctypes.POINTER(BASS_WASAPI_INFO))(
...
BASS_WASAPI_Lock = func_type(HSTREAM, ctypes.c_bool)(
...
BASS_WASAPI_Stop = func_type(HSTREAM, ctypes.c_bool)(
...
BASS_WASAPI_PutData = func_type(HSTREAM, ctypes.c_void_p, ctypes.c_ulong)(
    ("BASS_WASAPI_PutData", basswasapi_module)
)
# DWORD BASSDEF(BASS_WASAPI_GetData)(void *buffer, DWORD length);
BASS_WASAPI_GetData = func_type(HSTREAM, ctypes.c_void_p, ctypes.c_ulong)(
...
if __name__ == "__main__":
    ...
    if not BASS_WASAPI_Init(
        ...
        if not BASS_WASAPI_Init(
            ...
            print("BASS_WASAPI error %s") % get_error_description(
                BASS_ErrorGetCode()
            )
